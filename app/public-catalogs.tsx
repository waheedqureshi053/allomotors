...
export default function CatalogueParticulierScreen() {
      ...
      if (item?.Attributes) {
        if (typeof item.Attributes === "string") {
          try {
            ...
            // if (parsedAttributes)
            //   item.OwnerAttributes = JSON.parse(parsedAttributes?.OwnwerAttributes);
            // console.log("🚮 OwnerAttributes from parsedAttributes: 🚮", parsedAttributes.OwnerAttributes);
    ...
    <FlatList
      ...
      ListHeaderComponent={
        <>
          ...
          <View className="flex flex-row items-start items-center gap-5 mx-5 mt-5">
            <View>
